...
local Tab = Window:CreateTab("Generators") 
...
local Label = Tab:CreateLabel("Credit to uhh i forgor💀💀💀 (sonixdev on discord yasuf community prob yea)", 0, Color3.fromRGB(90, 90, 90), false) -- Title, Icon, Color, IgnoreTheme
